...
Sri Harsha Joshi is a dedicated developer with 3+ years of professional experience, skilled in building robust and efficient applications using technologies including Python, Java, and JavaScript. Committed to innovation and code quality, Sri Harsha Joshi ensures the continued development and support of this project, aiming to provide valuable solutions for multi-object tracking and related computer vision tasks.

For inquiries or collaborations, you can reach out via:
- GitHub: [harshajoshi3103](https://github.com/harshajoshi3103)
- LinkedIn: [Sri Harsha Joshi](https://www.linkedin.com/in/sri-harsha-joshi)
