...
This repository uses `ort` crate, which is ONNXRuntime wrapper for Rust. (https://docs.rs/ort/latest/ort/)
...
- step2: Set environment variable `PATH` for linking.
...
This project is currently maintained by Sri Harsha Joshi.  Contact: harshajoshi3103@gmail.com
